...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //set the adapter to the RecyclingView in our layout
        ...
        //observe the nights(data) in our ViewModel if it changed put the new list to the list in the adapter
